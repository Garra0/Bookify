...
internal sealed class AuthorizationService
{
    ...
    public async Task<UserRolesResponse> GetRolesForUserAsync(string identityId)
    {
        ...
        // حكينا وكررنا وعدنا وزدنا انو الاسطر التالية راح نتاديها بكل ريكويست مشان هيك
        // قررنا نخفف هتز على الديبي ونستخدم الكاش يا معلم والبوس عنا هو الريدس تووو ديييه! كاااش ناو
