...
public class UserTests : BaseTest
{
    ...
    public void Create_Should_SetPropertyValue()
    {
        ...
        // arrange شو هي الشغلات اللي بحتاجها مشان اشغل التيست من اوبجكت وغيرها
        // act التيست الفعلي 
        // assert للتحق من النتيجة

        // arrange 
        // عملنا شيرد كلاس اسمه UserData فيه البيانات اللي رح نستخدمها بالتيست
